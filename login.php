...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      if($row['user_type'] == 'admin'){
         ...
         $message[] = 'هیچ بەكارهێنەرێك نەدۆزرابەوە';
      }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="submit" class="btn" name="submit" value="ئێستا بچۆرە ژوورەوە">
      <p>ئەکاونتت نیە؟ <a href="register.php">ئێستا خۆت تۆماربکە</a></p>
   </form>
