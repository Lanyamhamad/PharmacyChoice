...
if(isset($_POST['update_product'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         //$message[] = 'وێنەکە بە سەرکەوتوویی نوێکرایەوە';
      }
   }

   $message[] = 'بەرهەمەکە بە سەرکەوتوویی نوێکرایەوە';
...
<div class="direction" style="direction: rtl;">
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="نوێكردنەوەی بەرهەمەكە" name="update_product" class="btn">
      <a href="admin_products.php" class="option-btn">گەڕانەوە</a>
   </form>
...
<?php
      ...
      echo '<p class="empty">هیچ بەرهەمێکی نوێکردنەوە هەڵبژێرە</p>';
   }
?>
